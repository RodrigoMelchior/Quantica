...
@RestController
@CrossOrigin()
@RequestMapping(path = "/api/perguntas")
public class PerguntaResource extends EntityServiceBasedRestController<Pergunta, Long, PerguntaService>{
    ...
    public ResponseEntity<List<Pergunta>> pesquisar(@RequestBody FiltroPerguntaDTO filtro) {
    	...
    	String enunciado = filtro.getEnunciado();
